...
send_msg(extra.chatid, ''..#result..' پیام اخیر سوپر گروه توسط پاور اسپید حذف شد', ok_cb, false)
else
send_msg(extra.chatid, 'تمام پیام های سوپر ✅ گروه توسط پاور اسپید حذف شد', ok_cb, false)
end
end
